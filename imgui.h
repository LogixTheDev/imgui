...
struct ImFontAtlas
{
    ...
    void                        SetTexID(ImTextureUserID id){ TexID._TexData = NULL; TexID._TexUserID = id; }   // Called by legacy backends.
    void                        SetTexID(ImTextureID id)    { TexID = id; }                                     // Called by legacy backends.
#endif
